...
phar_art_one = PharaohArticle.where(pharaoh_id: Pharaoh.where(name: 'Tutankhamun').first.id , article_id: Article.where(title: 'The New Kingdom & the Amarna Period').first.id).first  ##DELETE dependancies first!
